...
# Caso o nível seja maior do que 450, um aviso deve ser exibido pelo seu programa
...
for estado in niveis_co2:
    ...
    if media_co2 > 450:
        print('{} está com níveis altíssimos de CO2({}), chamar equipe especializada para verificar a região'.format(
            estado, media_co2))
